            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-100">
                  <tr>
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Order ID</th>
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Table No.</th>
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Customer Name</th>
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Items Ordered</th>
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Total Price</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {orders.map(order => (
                    <tr key={order.id}>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap">{order.tableNo}</td>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap">{order.totalPrice} Rs</td>
                      <td className="px-4 py-2 whitespace-nowrap">
                        <select
                          value={order.status}
